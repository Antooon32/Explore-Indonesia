...
class SimpleSlider {
    constructor(selector, lightboxManager) { 
        ...
        this.items.forEach(item => {
            ...
            if (image) {
                image.addEventListener('click', (e) => {
                    e.preventDefault(); 
                    this.lightboxManager.openLightbox(image.src); 
                });
            }
        });
    }
...
document.addEventListener("DOMContentLoaded", () => {
    const globalLightbox = new LightboxManager();

    const sliderElement = document.querySelector(".slider");
    if (sliderElement) {
        new SimpleSlider(".slider", globalLightbox);
    }

    const galleryImages = document.querySelectorAll(".gallery-list__item img");
    ...
    galleryImages.forEach(image => {
        image.addEventListener('click', (e) => {
            ...
            globalLightbox.openLightbox(imageSrc); 
        });
    });
});